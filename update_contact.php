    ...
    <div class="row vh-100 justify-content-center align-items-center ">
        <div class="col-12 col-md-4" class="shadow-lg">
            <div class="bg-white py-3 px-4 rounded ">
                <h4 class="text-info fw-bold text-center mb-2">Update contact</h4>
                <?php
                $id = $_GET['id'];
                $current = fetchContact($id);
                ...
                <form action="" method="post" enctype="multipart/form-data" >
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="<?php echo $current['name']; ?>">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="email" name="email" id="email" class="form-control" value="<?php echo $current['email']; ?>">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="phone" name="phone" id="phone" class="form-control" value="<?php echo $current['phone']; ?>">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="file" name="upload" id="upload" class="form-control" value="<?php echo $current['photo_name'] ?>">
